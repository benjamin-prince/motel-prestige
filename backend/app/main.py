...
from .routers import auth, housekeeping, maintenance, inventory, fnb, sales, hr, dashboard, revenue
...
app.include_router(revenue.router,      prefix="/api", dependencies=_auth)
